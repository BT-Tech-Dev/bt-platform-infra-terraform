...
variable "production_dispatch_backend" { type = string }
variable "ms05_tasks_location" { type = string }
variable "ms05_tasks_queue" { type = string }
variable "ms05_tasks_service_account_email" { type = string }
variable "ms05_worker_target_url" { type = string }
variable "ms05_tasks_dispatch_deadline_seconds" { type = number }
