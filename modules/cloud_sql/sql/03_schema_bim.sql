...
CREATE TABLE IF NOT EXISTS bim.project_element_identifier (
...
CREATE INDEX IF NOT EXISTS idx_project_element_registry_bim_element
    ON bim.project_element_registry(bim_element_id);
CREATE INDEX IF NOT EXISTS idx_project_element_identifier_element
    ON bim.project_element_identifier(project_element_id);
CREATE UNIQUE INDEX IF NOT EXISTS uq_project_element_identifier_primary_type
